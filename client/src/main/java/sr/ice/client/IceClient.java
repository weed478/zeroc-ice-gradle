...
public class IceClient {
	public static void main(String[] args) throws IOException {
		...
		ObjectPrx base1 = communicator.stringToProxy(
			"calc/calc11:tcp -h 127.0.0.1 -p 10000 -z : udp -h 127.0.0.1 -p 10000 -z");
			//opcja -z włącza możliwość kompresji wiadomości
		...
		do {
			...
			switch (line) {
				...
				case "avg":
					try {
						float avg = obj1.avg(new long[]{1, 2, 3, 4, 5});
						System.out.println("RESULT = " + avg);
						avg = obj1.avg(new long[]{});
						System.out.println("RESULT = " + avg);
